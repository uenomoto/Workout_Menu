// フォーム全体の要素
  ...
  var userIntroductionField = document.querySelector("#userIntroduction");
  var userPrefectureField = document.querySelector("#userPrefecture");
...
　// 各入力フィールド内の<input>タグ
  ...
  var userIntroduction = document.querySelector("#user_introduction");
  var userPrefecture = document.querySelector("#user_prefecture");
  ...
  var prefecturePara = document.createElement('p');
